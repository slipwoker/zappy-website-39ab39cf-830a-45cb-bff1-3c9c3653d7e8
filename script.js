document.addEventListener('DOMContentLoaded', function () {
    ...
    fields.forEach(function (field) {
      ...
      if (value !== '') {
        ...
        if (field.hasAttribute('maxlength')) {
          ...
          if (value.length > max) {
            showFieldError(field, 'Maximum ' + max + ' characters allowed.');
            isValid = false;
            if (!firstInvalidField) firstInvalidField = field;
            return;
          }
  ...
  function clearFormErrors(form) {
    ...
    form.querySelectorAll('.form-success-message, .form-submit-error').forEach(function (el) {
      el.remove();
    });
  }
      ...
      function (entries) {
        entries.forEach(function (entry) {
          if (entry.isIntersecting) {
            ...
            entry.target.classList.remove(OBSERVE_CLASS);
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "N&M כיפות משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '39ab39cf-830a-45cb-bff1-3c9c3653d7e8',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '39ab39cf-830a-45cb-bff1-3c9c3653d7e8';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '39ab39cf-830a-45cb-bff1-3c9c3653d7e8';
